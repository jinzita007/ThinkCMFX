...
.table_list tr.expanded td .expander{
	background: url(/ThinkCMFX/admin/themes/simplebootx/Public/assets/images/tv-collapsable.gif) center center no-repeat;
}
.table_list tr.collapsed td .expander{
	background: url(/ThinkCMFX/admin/themes/simplebootx/Public/assets/images/tv-expandable.gif) center center no-repeat;
}
</style>
...
$(function(){
    $(".show_sub").click(function(){
        $(this).attr("src",function(){
            if(this.src == '/ThinkCMFX/admin/themes/simplebootx/Public/assets/images/tv-expandable.gif'){
                return '/ThinkCMFX/admin/themes/simplebootx/Public/assets/images/tv-collapsable.gif';
            } else {
                return '/ThinkCMFX/admin/themes/simplebootx/Public/assets/images/tv-expandable.gif';
            }
        });
